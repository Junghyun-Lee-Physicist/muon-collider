...
private:
    ...
    DimensionsManager* fDimensionsManager;
          double* fWorldSize_Width;
          double* fWorldSize_Height;
          double* fWorldSize_Length;
          double* fWorldEnvSize_Width;
          double* fWorldEnvSize_Height;
          double* fWorldEnvSize_Length;
    ...
    G4Box*             WorldEnvSol;
    G4LogicalVolume*   WorldEnvLog;
    G4VPhysicalVolume* WorldEnvPhy;
